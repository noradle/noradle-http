...
var urlParse = require('url').parse
  , fs = require('fs')
  , path = require('path')
  , prefix = '../node_modules/noradle-resultsets'
  , fileRSParser = fs.readFileSync(path.join(__dirname, prefix, 'RSParser.js'))
  , fileNGResultsetsConverter = fs.readFileSync(path.join(__dirname, prefix, 'ng-resultsets-converter.js'))
  , fileJQResultsetsConverter = fs.readFileSync(path.join(__dirname, prefix, 'jq-resultsets-converter.js'))
  ;
